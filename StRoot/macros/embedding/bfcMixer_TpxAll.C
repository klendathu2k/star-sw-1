...
void bfcMixer_Tpx( 
  ...
  bfcMixer_TpxAll( nevents_, daqfile_, tagfile_, ptmn_, ptmx_, etamn_, etamx_, vzmn_, vzmx_, vr_, pid_, mult_, triggers_, prodname, kintype, simIn, pidtype_, decays_, engine_ );
