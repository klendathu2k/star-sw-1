 ...
 * \brief Physical constants adapted from the CLHEP library.
 *
 * \details All values are expressed in the StarClassLibrary system of units
 * (see SystemOfUnits.h).  Constants are declared \c static to avoid
 * multiple-definition issues when included in several translation units.
 *
 * Constant groups provided:
 *  - Mathematical: pi, twopi, halfpi, pi2
 *  - Avogadro number
 *  - Speed of light and c²
 *  - Planck constant (h, ℏ, ℏc, ℏc²)
 *  - Elementary charge
 *  - Particle masses (electron, proton, neutron, amu; selected mesons/baryons)
 *  - Electromagnetic constants (μ₀, ε₀, fine-structure constant, Bohr radius, …)
 *  - Thermal / statistical: Boltzmann constant, STP conditions
 */
...
/// \name Avogadro constant (particles per mole)
/// @{
static const double Avogadro = 6.0221367e+23/mole;
/// @}

/// \name Speed of light
/// c   = 299.792458 mm/ns, c^2 = 898.7404 (mm/ns)^2
/// @{
...
/// \name Planck constant
/// h = 4.13566e-12 MeV*ns, hbar = 6.58212e-13 MeV*ns, hbarc = 197.32705e-12 MeV*mm
/// @{
...
/// \name Particle masses
/// Expressed in units of equivalent energy (MeV).
/// amu_c2: atomic equivalent mass unit; amu: atomic mass unit.
/// @{
...
/// mu0: permeability of free space = 2.01334e-16 MeV*(ns*eplus)^2/mm \n
/// epsilon0: permittivity of free space = 5.52636e+10 eplus^2/(MeV*mm)
/// @{
static const double mu0      = 4*pi*1.e-7 * henry/meter;
static const double epsilon0 = 1./(c_squared*mu0);
/// @}

/// \name Electromagnetic coupling and derived constants
/// elm_coupling = 1.43996e-12 MeV*mm/(eplus^2)
/// @{
...
/// \name Boltzmann constant
/// @{
static const double k_Boltzmann = 8.617385e-11 * MeV/kelvin;
/// @}

/// \name Standard Temperature and Pressure (STP) conditions
/// @{
